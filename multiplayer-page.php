	...
	<div class="container-md">
		...
		<nav>
		  <div class="nav nav-tabs" id="nav-tab" role="tablist">
			...
			<a class="nav-link active" id="nav-multiplayer-tab" data-bs-toggle="tab" data-bs-target="#nav-rankings" type="button" role="tab" onclick="document.location='multiplayer-page.php'" aria-controls="nav-multiplayer" aria-selected="true"><i class="fas fa-multiplayer"></i> Multiplayer</a>
